...
# Count ONLY coding annotations
coding_total <- sum(all_annotations %in% coding, na.rm = TRUE)
...
# Logical vectors (TRUE/FALSE for each row)
coding_variants <- grepl(coding, variants$INFO)

# Counts for VAF > 0.05 in each category
vaf_gt5 <- sum(vafs > 0.05, na.rm = TRUE)
